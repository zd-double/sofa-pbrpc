...
![输入图片说明](image/arch.png "在这里输入图片标题")
...
![输入图片说明](image/rpc-interface.png "在这里输入图片标题")
## 用户配置
Server端配置：RpcServerOptions
![输入图片说明](image/server-option.png "在这里输入图片标题")

Client端配置：RpcClientOptions
![输入图片说明](image/client-option.png "在这里输入图片标题")
# 快速使用
使用sofa-pbrpc只需要三步：
* 定义通讯协议
* 实现Server
...
![输入图片说明](image/basic_arch.png =958 × 831 "在这里输入图片标题")
...
![输入图片说明](image/rpc-header.png "在这里输入图片标题")
...
![输入图片说明](image/readbuf.png "在这里输入图片标题")
![输入图片说明](image/writebuf.png "在这里输入图片标题")
### 透明压缩
采用装饰着模式的透明压缩，易于扩展。
